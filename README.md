...
6) Still in "Configuration --> Meter": Enter the MEP Basic key in hex format, which should look like this: 58747A3B7E2C685656794F45404B79724F69562B .Enter this 40 char long MEP basic key which you must get from your local energy supplyer into the "Encryption key" field. Best practice is to copy/paste from an editor. After pasting the 40 char key a starting "0x" and 2 trailing zeros are shown....thats fine.
