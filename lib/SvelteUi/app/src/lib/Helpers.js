...
export function hertzcol(Hz) {                          //EHorvat new
    if(Hz > 49.8 && Hz < 50.2) return '#5a9d4f';        //EHorvat changed from 32d900 to 5a9d4f (a bit darker green)
    if(Hz > 49.7 && Hz < 50.3) return '#adc300';        //EHorvat from b1d900 to adc300 (a bit darker)
    if(Hz > 49.6 && Hz < 50.4) return '#ffb800';        //ffb800 is orange
