...
//    if(volt > 218 && volt < 242) return '#32d900';       //EHorvat disabled
//    if(volt > 212 && volt < 248) return '#b1d900';       //EHorvat disabled
//    if(volt > 208 && volt < 252) return '#ffb800';       //EHorvat disabled
    return '#297dbc';                                      //EHorvat changed to 297dbc was d90000
};

export function ampcol(pct) {
//    if(pct > 90) return '#d90000';            //EHorvat disabled
//    else if(pct > 85) return'#e32100';        //EHorvat disabled
//    else if(pct > 80) return '#ffb800';       //EHorvat disabled
//    else if(pct > 75) return '#dcd800';       //EHorvat disabled
//    else return '#32d900';                    //EHorvat disabled
    return '#297dbc';                           //EHorvat new...show export power always blue 297dbc
};

export function importcol(pct) {               //EHorvat new
    return '#7c3aed';                          //EHorvat new...show import power always in purple 7c3aed

    };export function exportcol(pct) {
        //    if(pct > 75) return '#32d900';       //EHorvat disabled
        //    else if(pct > 50) return '#77d900';  //EHorvat disabled
        //    else if(pct > 25) return '#94d900';  //EHorvat disabled
        //    else return '#dcd800';               //EHorvat disabled
...
export function hanError(err) {
    switch(err) {
        ...
        case 90: return "No mep data received for at least 30s";
