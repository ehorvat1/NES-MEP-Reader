...
// //EHorvat 5 Minute plot (short plot now 10 Minutes...)
var sp;
var sa;
var so = {
    title: 'letzte 10 Minuten',  // ****** EHorvat was Energy use last 5 Minutes
    titleTextStyle: {
        fontSize: 14
    },
...
//EHorvat new 5 Minute plot  .... now last 10 Min
var drawMinute = function() {
    $.ajax({
        ...
        for(var i = 119; i > -1; i--) {   // Show current data on right side
            ...
            data[r++] = ["vor " + ((i+1)*10) + " Sek.", val, "opacity: 0.9;"]; //  EHorvat ... just one line
