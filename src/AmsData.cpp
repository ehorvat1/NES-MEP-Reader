...
void AmsData::apply(AmsData& other) {
   ...
   //  this->lastUpdateMillis = other.getLastUpdateMillis();        //EHorvat NES-MEP
    ...
    this->listType = 4;                                             //EHorvat NES-MEP changed to 4 (was 3)
...
//        case 3:
            this->meterTimestamp = other.getMeterTimestamp();               //Enabled for testing ram
...
//            this->reactiveExportCounter = NESMEP_ReactiveExportCounter;   //EHorvat NES-MEP  Send mep_alivecounter instead of ReactiveExportCounter....
...
//           this->activeExportPower = NESMEP_ActiveImportPower / 3;  //EHorvat NES-MEP test
...
//    return NESMEP_ActiveImportCounter - 1400;        // EHorvat NES-MEP
}

double AmsData::getReactiveExportCounter() {
//    return this->reactiveExportCounter;       // EHorvat NES-MEP
