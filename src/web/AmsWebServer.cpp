...
void AmsWebServer::setup(AmsConfiguration* config, GpioConfig* gpioConfig, MeterConfig* meterConfig, AmsData* meterState, AmsDataStorage* ds, EnergyAccounting* ea) {
	...
	server.on("/dayplot.json", HTTP_GET, std::bind(&AmsWebServer::dayplotJson, this)); // was dayplotJson
...
void AmsWebServer::configMeterHtml() {
	...
	if(meterConfig->encryptionKey[0] != 0x00) {
		...
		encryptionKeyHex += toHex(meterConfig->encryptionKey, 21);  //EHorvat 21 was 16
...
void AmsWebServer::dataJson() {
	...
	if(meterConfig->baud == 0) {
		hanStatus = 0; //EHorvat invisible 
	} else if(now - meterState->getLastUpdateMillis() < 15000) {
		hanStatus = 1;//EHorvat green  
	} else if(now - meterState->getLastUpdateMillis() < 30000) {  
		hanStatus = 2;//EHorvat orange 
	} else {
		hanStatus = 3;//EHorvat red 
	}
...
void AmsWebServer::minuteplotJson() {
	...
	if(ds == NULL) {
		...
		snprintf_P(buf, BufferSize, MINUTEPLOT_JSON,
			...
			ds->get5MinuteWatt(120),
			ds->get5MinuteWatt(121),
			ds->get5MinuteWatt(122),
			ds->get5MinuteWatt(123),
			ds->get5MinuteWatt(124),
			ds->get5MinuteWatt(125),
			ds->get5MinuteWatt(126),
			ds->get5MinuteWatt(127),
			ds->get5MinuteWatt(128),
			ds->get5MinuteWatt(129),
			ds->get5MinuteWatt(130),
			ds->get5MinuteWatt(131),
			ds->get5MinuteWatt(132),
			ds->get5MinuteWatt(133),
			ds->get5MinuteWatt(134),
			ds->get5MinuteWatt(135),
			ds->get5MinuteWatt(136),
			ds->get5MinuteWatt(137),
			ds->get5MinuteWatt(138),
			ds->get5MinuteWatt(139),
			ds->get5MinuteWatt(140),
			ds->get5MinuteWatt(141),
			ds->get5MinuteWatt(142),
			ds->get5MinuteWatt(143),
			ds->get5MinuteWatt(144),
			ds->get5MinuteWatt(145),
			ds->get5MinuteWatt(146),
			ds->get5MinuteWatt(147),
			ds->get5MinuteWatt(148),
			ds->get5MinuteWatt(149),
			ds->get5MinuteWatt(150),
			ds->get5MinuteWatt(151),
			ds->get5MinuteWatt(152),
			ds->get5MinuteWatt(153),
			ds->get5MinuteWatt(154),
			ds->get5MinuteWatt(155),
			ds->get5MinuteWatt(156),
			ds->get5MinuteWatt(157),
			ds->get5MinuteWatt(158),
			ds->get5MinuteWatt(159),
			ds->get5MinuteWatt(160),
			ds->get5MinuteWatt(161),
			ds->get5MinuteWatt(162),
			ds->get5MinuteWatt(163),
			ds->get5MinuteWatt(164),
			ds->get5MinuteWatt(165),
			ds->get5MinuteWatt(166),
			ds->get5MinuteWatt(167),
			ds->get5MinuteWatt(168),
			ds->get5MinuteWatt(169),
			ds->get5MinuteWatt(170),
			ds->get5MinuteWatt(171),
			ds->get5MinuteWatt(172),
			ds->get5MinuteWatt(173),
			ds->get5MinuteWatt(174),
			ds->get5MinuteWatt(175),
			ds->get5MinuteWatt(176),
			ds->get5MinuteWatt(177),
			ds->get5MinuteWatt(178),
			ds->get5MinuteWatt(179)
		);
...
void AmsWebServer::handleSave() {
	...
	if(server.hasArg("mc") && server.arg("mc") == "true") {
		...
		if(!encryptionKeyHex.isEmpty()) {
			...
			fromHex(meterConfig->encryptionKey, encryptionKeyHex, 21);  //EHorvat now 21 (was 16)
...
//		server.sendContent(buf, snprintf_P(buf, BufferSize, (char*) F("dayplot %d %lld %lu %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d"),  //original
		server.sendContent(buf, snprintf_P(buf, BufferSize, (char*) F("dayplot %d %ld %ld %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d"),   //EHorvat changed to ld was lld and lu --> ld
			day.version,
			day.lastMeterReadTime,   // EHorvat removed starting "(int64_t) "
			day.activeImport,
			ds->getHourImport(0),
			ds->getHourImport(1),
			ds->getHourImport(2),
...
//		server.sendContent(buf, snprintf_P(buf, BufferSize, (char*) F("monthplot %d %lld %lu %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d"), 
		server.sendContent(buf, snprintf_P(buf, BufferSize, (char*) F("monthplot %d %ld %ld %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d"), //EHorvat changed to ld was lld
			month.version,
			month.lastMeterReadTime,    // EHorvat removed starting "(int64_t) "
			month.activeImport,
			ds->getDayImport(1),
			ds->getDayImport(2),
			ds->getDayImport(3),
